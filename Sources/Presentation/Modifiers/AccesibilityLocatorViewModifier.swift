...
private struct AccesibilityLocatorViewModifier: ViewModifier {
  private let identifier: String
  private let value: String

  init(by locatorType: LocatorType) {
    identifier = locatorType.id
    value = locatorType.value()
  }

  init(by locatorType: LocatorType, with identifier: String) {
...
enum Locators: String, LocatorType {
  var id: String {
    rawValue
  }
